...
use \Impact\DiscordAuth\Entity\Guild;
use \Impact\DiscordAuth\Collection\Guilds;
use App\Email;
...
class Manager
{
        ...
        try {
            ...
            switch ($e->getCode()) {
                ...
                case 429:
                    ...
                    throw new \Impact\DiscordAuth\Exception\RateLimit($message);
                    break;
                case 401:
                    $body = (string)$e->getResponse()->getBody();
                    throw new \Impact\DiscordAuth\Exception\NotAllowed($body);
                    break;
            }
        }
        return false;
    ...
    public function getUser()
    {
        ...
        return new \Impact\DiscordAuth\Entity\User((array)$result);
    }
}
